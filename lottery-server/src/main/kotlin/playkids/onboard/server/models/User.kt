...
data class User(val id: Int? = null, var username: String, var email: String,
                var password: String, var credit: Int = 50, val tickets: List<playkids.onboard.server.models.Ticket>? = null) {
    init {
...
class UserEntity(id: EntityID<Int>) : IntEntity(id) {
    ...
    var tickets: List<playkids.onboard.server.models.Ticket>? = null
